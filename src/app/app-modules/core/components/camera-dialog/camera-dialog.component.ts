import { Component, OnInit, Output, EventEmitter, ElementRef, ViewChild, HostListener, DoCheck } from '@angular/core';
...
export class CameraDialogComponent implements OnInit, DoCheck {
  ...
  pointMark(event) {
    ...
    if (this.score <= 6) {
      ...
      setTimeout(() => {
        this.confirmationService.alert(this.current_language_set.alerts.info.sixMakers);
      }, 0);
    }
    // } else {
