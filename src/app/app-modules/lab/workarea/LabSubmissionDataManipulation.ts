    ...
    labComponentRestruct(compList) {
        ...
        compList.forEach((element, i) => {
            if(element.stripsNotavailable){
                if(element.testComponentName.includes('ECG') && element.testComponentID && element.compOptSelected === "Abnormal"){
                    comps.push({
                ...
                if(element.testComponentName.includes('ECG') && element.testComponentID && element.compOptSelected && element.compOptSelected === "Abnormal") {
                    comps.push({
                        testComponentID: element.testComponentID,
                        testResultValue: element.inputValue || element.compOptSelected,
                        testResultUnit: element.measurementUnit || undefined,
                ...
                else if ((element.testComponentID && element.inputValue)
