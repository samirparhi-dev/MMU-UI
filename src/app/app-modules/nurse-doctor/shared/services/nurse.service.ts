...
export class NurseService {
  ...
  postNurseCancerVisitForm(medicalForm, imageCoordinates, sendToDoctorWorklist) {
    let temp = {
    ...
    cancerVisitDetails = Object.assign(cancerVisitDetails, { sendToDoctorWorklist }, {
      ...
      parkingPlaceID: parkingPlaceID, vanID: vanID, serviceID: serviceID, createdBy: createdBy
    })
  ...
  postNurseGeneralQCVisitForm(medicalForm) {
    let temp = {
      beneficiaryRegID: "" + localStorage.getItem('beneficiaryRegID'),
      providerServiceMapID: localStorage.getItem('providerServiceID'),
      createdBy: localStorage.getItem('userName')
    ...
    let visitDetails = Object.assign({}, medicalForm.controls.patientVisitForm.controls.patientVisitDetailsForm.value, medicalForm.controls.patientVisitForm.controls.patientFileUploadDetailsForm.value, temp);
    let vitalsDetails = Object.assign({}, medicalForm.controls['patientVitalsForm'].value, temp);
    let generalQCVisitDetails = Object.assign({}, { 'visitDetails': visitDetails }, { 'vitalsDetails': vitalsDetails }, { benFlowID: localStorage.getItem('benFlowID'), beneficiaryID: localStorage.getItem('beneficiaryID'), sessionID: localStorage.getItem('sessionID'), parkingPlaceID: parkingPlaceID, vanID: vanID, serviceID: serviceID, createdBy: createdBy });
  ...
  postNurseANCVisitForm(medicalForm, benVisitID, visitCategory, benAge) {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID
    let serviceID = localStorage.getItem('serviceID');
    let createdBy = localStorage.getItem('userName');
  ...
  */
  ...
  postGeneralPersonalHistory(personalHistoryForm, otherDetails) {
    ...
    let personalHistoryData = Object.assign({}, personalHistoryFormValue, otherDetails, {
      riskySexualPracticesStatus: personalHistoryForm.value.riskySexualPracticesStatus ? +(personalHistoryForm.value.riskySexualPracticesStatus) : null,
  ...
  postNCDScreeningForm(medicalForm, visitCategory) {
    let serviceDetails = {
      beneficiaryRegID: localStorage.getItem('beneficiaryRegID'),
      benVisitID: null,
      providerServiceMapID: localStorage.getItem('providerServiceID'),
    ...
    let ncdScreeningVitalDetails = Object.assign({}, medicalForm.controls.patientVitalsForm.value)
    ...
    { 'historyDetails': this.postNCDScreeningHistoryForm(medicalForm.controls.patientHistoryForm, null, visitCategory) },
  ...
  postNurseGeneralOPDVisitForm(medicalForm, visitCategory, beneficiary) {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID
    let serviceID = localStorage.getItem('serviceID');
    let createdBy = localStorage.getItem('userName');
  ...
  postNurseNCDCareVisitForm(medicalForm, visitCategory, beneficiary) {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID
    let serviceID = localStorage.getItem('serviceID');
    let createdBy = localStorage.getItem('userName');
  ...
  postNurseCovidCareVisitForm(medicalForm, visitCategory, beneficiary) {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID
    let serviceID = localStorage.getItem('serviceID');
    let createdBy = localStorage.getItem('userName');
    ...
    console.log("Nurse Covid CARE Visit Details", JSON.stringify(nurseGeneralOPDVisitDetails, null, 4));

    return this.http.post(environment.saveNurseCovidCareDetails, nurseGeneralOPDVisitDetails)
      .map(res => res.json()).pipe(shareReplay(1));
  }


  postNursePNCVisitForm(medicalForm, visitCategory, beneficiary) {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID
    let serviceID = localStorage.getItem('serviceID');
    let createdBy = localStorage.getItem('userName');
  ...
  getTMReferredCasesheetData(reqObj)
  {
