...
export class DoctorService {
  ...
  updateBeneficiaryArrivalStatus(arrivalStatusDetails) {
    return this.http.post(environment.updateBeneficiaryArrivalStatusUrl, arrivalStatusDetails)
  ...
  getSpecialistWorklist() {
    return this.http.get(environment.specialistWorkListURL + localStorage.getItem('providerServiceID') + `/${localStorage.getItem('serviceID')}/${localStorage.getItem('userID')}`)
      .map(res => res.json());
  }

  getDoctorFutureWorklist() {
    return this.http.get(environment.doctorFutureWorkList + localStorage.getItem('providerServiceID') + `/${localStorage.getItem('serviceID')}`)
      .map(res => res.json());
  }

  getSpecialistFutureWorklist() {
    return this.http.get(environment.specialistFutureWorkListURL + localStorage.getItem('providerServiceID') + `/${localStorage.getItem('serviceID')}/${localStorage.getItem('userID')}`)
      .map(res => res.json());
  }
  ...
  confirmStatus(benVisitID: any) {
    return this.http.post(environment.updateVisitStatus, { benVisitID: benVisitID })
      .map(res => res.json()).pipe(shareReplay(1));
  }
  ...
  getMMUHistory() {
    ...
    return this.http.post(environment.previousMMUHistoryUrl, { "beneficiaryRegID": benRegID })
      .map(res => res.json());
  }

  getTMHistory() {
    const benRegID = localStorage.getItem('beneficiaryRegID')
    return this.http.post(environment.previousTMHistoryUrl, { "beneficiaryRegID": benRegID })
      .map(res => res.json());
  }

  getMCTSHistory() {
    const benRegID = localStorage.getItem('beneficiaryRegID')
    return this.http.post(environment.previousMCTSHistoryUrl, { "beneficiaryRegID": benRegID })
      .map(res => res.json());
  }

  get104History() {
    const benRegID = localStorage.getItem('beneficiaryRegID')
    return this.http.post(environment.previous104HistoryUrl, { "beneficiaryRegID": benRegID })
      .map(res => res.json());
  }
  ...
  postDoctorCancerVisitDetails(cancerForm, tcRequest) {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    ...
    let diagnosis = Object.assign({}, diagnosisDetails, referDetails, otherDetails,);
    let cancerRequest = Object.assign({ tcRequest: tcRequest, diagnosis: diagnosis })
    console.log("Doctor Cancer visit Details", JSON.stringify(cancerRequest, null, 4));
    return this.http.post(environment.saveDoctorCancerScreeningDetails, cancerRequest)
      .map(res => res.json()).pipe(shareReplay(1));
  }

  getVisitDetails(beneficiaryID: string, visitID: string) {
    return this.http.post(environment.getCancerScreeningVisitDetails, { benRegID: beneficiaryID, benVisitID: visitID, visitCode: localStorage.getItem('visitCode') })
      .map(res => res.json());
  }

  getCancerHistoryDetails(beneficiaryID: string, visitID: string) {
    return this.http.post(environment.getCancerScreeningHistoryDetails, { benRegID: beneficiaryID, benVisitID: visitID, visitCode: localStorage.getItem('visitCode') })
      .map(res => res.json())
  }

  getCancerVitalsDetails(beneficiaryID: string, visitID: string) {
    console.log(beneficiaryID, visitID, 'null something')
    return this.http.post(environment.getCancerScreeningVitalsDetails, { benRegID: beneficiaryID, benVisitID: visitID, visitCode: localStorage.getItem('visitCode') })
      .map(res => res.json());
  }

  getCancerExaminationDetails(beneficiaryID: string, visitID: string) {
    return this.http.post(environment.getCancerScreeningExaminationDetails, { benRegID: beneficiaryID, benVisitID: visitID, visitCode: localStorage.getItem('visitCode') })
      .map(res => res.json());
  }

  updateCancerExaminationDetails(cancerExaminationForm, otherDetails, imageCoordinates): Observable<any> {
    ...
    if (cancerExaminationForm.controls.signsForm.dirty) {
      ...
      let lymphs = lymphsArray.map(item => Object.assign({}, item.value, otherDetails, { createdBy: localStorage.getItem('userName') }));
    ...
    if (cancerExaminationForm.controls.oralExaminationForm.dirty) {
      let oralExaminationDetails = cancerExaminationForm.controls.oralExaminationForm.value;
    ...
    console.log("Update Examination details", JSON.stringify(examinationDetails, null, 4));

    return this.http.post(environment.updateCancerScreeningExamination, examinationDetails)
      .map(res => res.json()).pipe(shareReplay(1));
  }

  updateCancerVitalsDetails(cancerVitals, disabledFormcontrolValue): Observable<any> {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID
    ...
    let patientVitalsDetails = Object.assign({}, cancerVitals, disabledFormcontrolValue, updateDetails);
    return this.http.post(environment.updateCancerScreeningVitals, patientVitalsDetails)
      .map(res => res.json()).pipe(shareReplay(1));
  }

  updateCancerHistoryDetails(patientHistoryForm, otherDetails) {
    let temp = {
      'familyHistory': this.cancerFamilyHistoryForm(patientHistoryForm.controls.cancerPatientFamilyMedicalHistoryForm, otherDetails),
      'personalHistory': this.cancerPersonalHistoryForm(patientHistoryForm.controls.cancerPatientPerosnalHistoryForm, otherDetails),
      'pastObstetricHistory': this.cancerObstetricHistoryForm(patientHistoryForm.controls.cancerPatientObstetricHistoryForm, otherDetails)
    }
  ...
  cancerFamilyHistoryForm(familyHistoryForm, otherDetails) {
    ...
    if (familyHistoryForm.dirty && familyHistoryForm.value.diseases != null) {
      let diseases = JSON.parse(JSON.stringify(familyHistoryForm.value.diseases));
      for (let i = 0; i < diseases.length; i++) {
        diseases[i].cancerDiseaseType = diseases[i].cancerDiseaseType.cancerDiseaseType;
  ...
  cancerObstetricHistoryForm(obstetricHistoryForm, otherDetails) {
    ...
    if (obstetricHistoryForm.dirty) {
      obstetricHistoryDetails = Object.assign({}, obstetricHistoryForm.value, otherDetails);
    }
  ...
  cancerPersonalHistoryForm(patientPerosnalHistoryForm, otherDetails) {
    ...
    if (patientPerosnalHistoryForm.dirty) {
      personalDetails = Object.assign({}, patientPerosnalHistoryForm.value, otherDetails);
    }
  ...
  postQuickConsultDetails(consultationData, tcRequest) {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID
    let temp = {
      beneficiaryRegID: localStorage.getItem('beneficiaryRegID'),
    ...
    let quickConsultation = Object.assign({}, consultationData.quickConsultation, temp);

    console.log('qc', JSON.stringify(quickConsultation, null, 4))
    return this.http.post(environment.saveDoctorGeneralQuickConsult, { quickConsultation })
      .map(res => res.json()).pipe(shareReplay(1));
  ...
  updateQuickConsultDetails(consultationData, tcRequest, isSpecialist) {
    ...
    console.log("updated quick consultation", JSON.stringify(quickConsultation, null, 4));
    return this.http.post(environment.updateGeneralOPDQuickConsultDoctorDetails, { quickConsultation })
      .map(res => res.json()).pipe(shareReplay(1));
  }
  ...
  */
  ...
  getNcdScreeningDetails(beneficiaryID, benVisitID) {
    return this.http.post(environment.getNCDScreeningDetails, { benRegID: beneficiaryID, benVisitID: benVisitID, visitCode: localStorage.getItem('visitCode') })
      .map(res => res.json());
  }
  ...
  updateNCDScreeningDetails(ncdScreeningFormValue, patientVisitFormValue) {
    ...
    let postNCDScreeningFormValue = JSON.parse(JSON.stringify(ncdScreeningFormValue));
    ...
    let ncdScreeningDetails = Object.assign({}, postNCDScreeningFormValue, serviceDetails, { benFlowID: localStorage.getItem('benFlowID') }, patientVisitFormValue.patientFileUploadDetailsForm);
    console.log('Update NCD Screening Data', JSON.stringify(ncdScreeningDetails, null, 4));

    return this.http.post(environment.updateNCDScreeningDetails, ncdScreeningDetails)
      .map(res => res.json()).pipe(shareReplay(1));
  }
  ...
  */
  ...
  postDoctorANCDetails(patientMedicalForm, otherDetails, tcRequest) {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID
    ...
    console.log("ANC Doctor Visit Details", JSON.stringify(ancVisitDetails, null, 4));
  ...
  updateANCDetails(patientANCForm, temp) {
    let updatedANCDetails = {
      ancObstetricDetails: this.updateANCDetailsandObstetricFormula(patientANCForm, temp),
      ancImmunization: this.updateANCImmunization(patientANCForm.controls.patientANCImmunizationForm, temp),
    }
    return this.http.post(environment.updateANCDetailsUrl, Object.assign({}, updatedANCDetails, temp))
      .map(res => res.json()).pipe(shareReplay(1));
  }
  ...
  getAncCareDetails(beneficiaryID: string, visitID: string) {
    return this.http.post(environment.getANCDetailsUrl, { benRegID: beneficiaryID, benVisitID: visitID, visitCode: localStorage.getItem('visitCode') })
      .map(res => res.json())
  }
  ...
  */
  ...
  postDoctorGeneralOPDDetails(patientMedicalForm, otherDetails, tcRequest) {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID
    let findingForm = (<FormGroup>patientMedicalForm.controls['patientCaseRecordForm']).controls['generalFindingsForm'];
    let investigationForm = (<FormGroup>patientMedicalForm.controls['patientCaseRecordForm']).controls['generalDoctorInvestigationForm'];
    ...
    let generalVisitDetails = {
      "findings": this.postGeneralCaseRecordFindings(findingForm, otherDetails),
      "diagnosis": this.postGeneralOPDCaseRecordDiagnosis(diagnosisForm, otherDetails),
      "investigation": this.postGeneralCaseRecordInvestigation(investigationForm, otherDetails),
      "prescription": this.postGeneralCaseRecordPrescription(prescriptionForm, otherDetails),
      "refer": this.postGeneralRefer(referForm, otherDetails),
      "benFlowID": localStorage.getItem('benFlowID'),
    ...
    console.log("Doctor Visit Details", JSON.stringify(generalVisitDetails, null, 4));

    return this.http.post(environment.saveDoctorGeneralOPDDetails, generalVisitDetails)
      .map(res => res.json()).pipe(shareReplay(1));
  ...
  */
  ...
  postDoctorNCDCareDetails(patientMedicalForm, otherDetails, tcRequest) {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID;
    let findingForm = (<FormGroup>patientMedicalForm.controls['patientCaseRecordForm']).controls['generalFindingsForm'];
    let investigationForm = (<FormGroup>patientMedicalForm.controls['patientCaseRecordForm']).controls['generalDoctorInvestigationForm'];
    ...
    let ncdCareVisitDetails = {
      "findings": this.postGeneralCaseRecordFindings(findingForm, otherDetails),
      "diagnosis": this.postNCDCareCaseRecordDiagnosis(diagnosisForm, otherDetails),
      "investigation": this.postGeneralCaseRecordInvestigation(investigationForm, otherDetails),
      "prescription": this.postGeneralCaseRecordPrescription(prescriptionForm, otherDetails),
      "refer": this.postGeneralRefer(referForm, otherDetails),
      "benFlowID": localStorage.getItem('benFlowID'),
    ...
    console.log("Doctor NCD CARE Visit Details", JSON.stringify(ncdCareVisitDetails, null, 4));

    return this.http.post(environment.saveDoctorNCDCareDetails, ncdCareVisitDetails)
      .map(res => res.json()).pipe(shareReplay(1));
  }
  ...
  */
  ...
  postDoctorCovidCareDetails(patientMedicalForm, otherDetails, tcRequest) {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID;
    let findingForm = (<FormGroup>patientMedicalForm.controls['patientCaseRecordForm']).controls['generalFindingsForm'];
    let investigationForm = (<FormGroup>patientMedicalForm.controls['patientCaseRecordForm']).controls['generalDoctorInvestigationForm'];
    ...
    let covidCareVisitDetails = {
      "findings": this.postGeneralCaseRecordFindings(findingForm, otherDetails),
      "diagnosis": this.postCovidCareCaseRecordDiagnosis(diagnosisForm, otherDetails),
      "investigation": this.postGeneralCaseRecordInvestigation(investigationForm, otherDetails),
      "prescription": this.postGeneralCaseRecordPrescription(prescriptionForm, otherDetails),
      "refer": this.postGeneralRefer(referForm, otherDetails),
      "benFlowID": localStorage.getItem('benFlowID'),
    ...
    console.log("Doctor Covid CARE Visit Details", JSON.stringify(covidCareVisitDetails, null, 4));

    return this.http.post(environment.saveDoctorCovidCareDetails, covidCareVisitDetails)
      .map(res => res.json()).pipe(shareReplay(1));
  }
  postDoctorNCDScreeningDetails(patientMedicalForm, otherDetails, tcRequest) {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID;
    let findingForm = (<FormGroup>patientMedicalForm.controls['patientCaseRecordForm']).controls['generalFindingsForm'];
    let investigationForm = (<FormGroup>patientMedicalForm.controls['patientCaseRecordForm']).controls['generalDoctorInvestigationForm'];
    ...
    let NCDScreeningDetails = {
      "findings": this.postGeneralCaseRecordFindings(findingForm, otherDetails),
      "diagnosis": this.postNCDscreeningCaseRecordDiagnosis(diagnosisForm, otherDetails),
      "investigation": this.postGeneralCaseRecordInvestigation(investigationForm, otherDetails),
      "prescription": this.postGeneralCaseRecordPrescription(prescriptionForm, otherDetails),
      "refer": this.postGeneralRefer(referForm, otherDetails),
      "benFlowID": localStorage.getItem('benFlowID'),
    ...
    console.log("Doctor Covid CARE Visit Details", JSON.stringify(NCDScreeningDetails, null, 4));

    return this.http.post(environment.saveDoctorNCDScreeningDetails, NCDScreeningDetails)
      .map(res => res.json()).pipe(shareReplay(1));
  }
  ...
  */
  ...
  getVisitComplaintDetails(beneficiaryID: string, visitID: string) {
    ...
    let otherDetails = Object.assign({ benRegID: beneficiaryID, benVisitID: visitID, visitCode: localStorage.getItem('visitCode') })

    if (!this.getVisitComplaint) {
      if (visitCategory == 'Cancer Screening') {
        this.getVisitComplaint = this.http.post(environment.getCancerScreeningVisitDetails, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'General OPD (QC)') {
        this.getVisitComplaint = this.http.post(environment.getGeneralOPDQuickConsultVisitDetails, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'ANC') {
        this.getVisitComplaint = this.http.post(environment.getANCVisitDetailsUrl, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'General OPD') {
        this.getVisitComplaint = this.http.post(environment.getGeneralOPDVisitDetailsUrl, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'NCD screening') {
        this.getVisitComplaint = this.http.post(environment.getNCDScreeningVisitDetails, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'NCD care') {
        this.getVisitComplaint = this.http.post(environment.getNCDCareVisitDetailsUrl, otherDetails)
          .map(res => res.json())
  ...
  getPregVisitComplaintDetails(beneficiaryID: string, visitID: string,visitCategory: string) {
    ...
    // if (!this.getPregVisitComplaint) {
      ...
      // if (visitCategory == 'NCD screening') {
        this.getPregVisitComplaint = this.http.post(environment.getNCDScreeningVisitDetails, otherDetails)
          .map(res => res.json())
// 
      // }
  ...
  getGeneralHistoryDetails(benRegID, visitID) {
    let visitCategory = localStorage.getItem('visitCategory');
    let otherDetails = Object.assign({ benRegID: benRegID, benVisitID: visitID, visitCode: localStorage.getItem('visitCode') })
    if (!this.generalHistory) {
      if (visitCategory == 'ANC') {
        this.generalHistory = this.http.post(environment.getANCHistoryDetailsUrl, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'General OPD') {
        this.generalHistory = this.http.post(environment.getGeneralOPDHistoryDetailsUrl, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'NCD care') {
        this.generalHistory = this.http.post(environment.getNCDCareHistoryDetailsUrl, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'PNC') {
        this.generalHistory = this.http.post(environment.getPNCHistoryDetailsUrl, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'COVID-19 Screening') {
        this.generalHistory = this.http.post(environment.getCovidCareHistoryDetailsUrl, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'NCD screening') {
        this.generalHistory = this.http.post(environment.getNCDScreeningHistoryDetails, otherDetails)
          .map(res => res.json())
  ...
  getGenericVitals(beneficiary) {
    let otherDetails = Object.assign({}, beneficiary, { visitCode: localStorage.getItem('visitCode') })
    let visitCategory = localStorage.getItem('visitCategory')
    if (visitCategory == 'General OPD (QC)') {
      return this.http.post(environment.getGeneralOPDQuickConsultVitalDetails, otherDetails)
        .map(res => res.json().data)
    }
    if (visitCategory == 'ANC') {
    ...
    if (visitCategory == 'General OPD') {
      return this.http.post(environment.getGeneralOPDVitalDetailsUrl, otherDetails)
        .map(res => res.json().data)
    }

    if (visitCategory == 'NCD care') {
      return this.http.post(environment.getNCDCareVitalDetailsUrl, otherDetails)
        .map(res => res.json().data)
    }
    if (visitCategory == 'PNC') {
    ...
    if (visitCategory == 'COVID-19 Screening') {
      return this.http.post(environment.getCovidCareVitalDetailsUrl, otherDetails)
        .map(res => res.json().data)
    }
    if (visitCategory == 'NCD screening') {
      return this.http.post(environment.getNCDSceeriningVitalDetails, otherDetails)
        .map(res => res.json().data)
    }
  }
  ...
  getGeneralExamintionData(beneficiaryID: string, visitID: string) {
    ...
    if (visitCategory == 'General OPD') {
      return this.http.post(environment.getGeneralOPDExaminationDetailsUrl, otherDetails)
        .map(res => res.json())
    }
    if (visitCategory == 'PNC') {
  ...
  updateGeneralHistory(generalHistoryForm, temp, beneficiaryAge) {
    ...
    let updatedHistoryDetails = {
      "pastHistory": this.updateGeneralPastHistory(generalHistoryForm.controls.pastHistory, temp),
      "comorbidConditions": this.updateGeneralComorbidityHistory(generalHistoryForm.controls.comorbidityHistory, temp),
      "medicationHistory": this.updateGeneralMedicationHistory(generalHistoryForm.controls.medicationHistory, temp),
      "femaleObstetricHistory": this.updateGeneralPastObstetricHistory(generalHistoryForm.controls.pastObstericHistory, temp),
      "menstrualHistory": this.updateGeneralMenstrualHistory(generalHistoryForm.controls.menstrualHistory, temp),
      "familyHistory": this.updateGeneralFamilyHistory(generalHistoryForm.controls.familyHistory, temp),
      "personalHistory": this.updateGeneralPersonalHistory(generalHistoryForm.controls.personalHistory, temp),
      "childVaccineDetails": this.updateGeneralOtherVaccines(generalHistoryForm.controls.otherVaccines, temp),
      "immunizationHistory": this.updateGeneralImmunizationHistory(generalHistoryForm.controls.immunizationHistory, temp),
      "developmentHistory": this.updateGeneralDevelopmentHistory(generalHistoryForm.controls.developmentHistory, temp),
      "feedingHistory": this.updateGeneralFeedingHistory(generalHistoryForm.controls.feedingHistory, temp),
      "perinatalHistroy": this.updateGeneralPerinatalHistory(generalHistoryForm.controls.perinatalHistory, temp),
      sessionID: localStorage.getItem('sessionID'),
      parkingPlaceID: parkingPlaceID, vanID: vanID,
      beneficiaryRegID: "" + localStorage.getItem('beneficiaryRegID'),
      providerServiceMapID: localStorage.getItem('providerServiceID'),
    ...
    console.log("Update General History", JSON.stringify(updatedHistoryDetails, null, 4));
    ...
    if (visitCategory == 'ANC') {
      ...
      return this.http.post(environment.updateANCHistoryDetailsUrl, updatedHistoryDetails)
        .map(res => res.json()).pipe(shareReplay(1));
    }

    if (visitCategory == 'General OPD') {
      return this.http.post(environment.updateGeneralOPDHistoryDetailsUrl, updatedHistoryDetails)
        .map(res => res.json()).pipe(shareReplay(1));
    }

    if (visitCategory == 'NCD care') {
      return this.http.post(environment.updateNCDCareHistoryDetailsUrl, updatedHistoryDetails)
        .map(res => res.json()).pipe(shareReplay(1));
    }
    ...
    if (visitCategory == 'PNC') {
      ...
      return this.http.post(environment.updatePNCHistoryDetailsUrl, updatedHistoryDetails)
        .map(res => res.json()).pipe(shareReplay(1));
    }

    if (visitCategory == 'COVID-19 Screening') {
      return this.http.post(environment.updateCovidCareHistoryDetailsUrl, updatedHistoryDetails)
        .map(res => res.json()).pipe(shareReplay(1));
    }
  ...
  updateGeneralFeedingHistory(feedingHistoryForm, otherDetails) {
    ...
    let feedingHistoryData = Object.assign({}, feedingHistoryFormValue, otherDetails, {
      foodIntoleranceStatus: !feedingHistoryFormValue.foodIntoleranceStatus ? feedingHistoryFormValue.foodIntoleranceStatus : +(feedingHistoryFormValue.foodIntoleranceStatus)
    });
  ...
  updateGeneralPastHistory(pastHistory, otherDetails) {
    ...
    illness.map(item => {
      ...
      if (temp) {
        ...
        item.timePeriodAgo = item.timePeriodAgo ? "" + item.timePeriodAgo : null;
      }
    })
    ...
    let historyData = Object.assign({}, pastHistoryForm.value, otherDetails, { pastIllness: illness, pastSurgery: surgery });
    return historyData;
  }

  updateGeneralComorbidityHistory(comorbidityHistoryForm, otherDetails) {
    let comorbidityHistoryFormData = JSON.parse(JSON.stringify(comorbidityHistoryForm.value));
    let comorbidityConcurrentConditions = Object.assign([], comorbidityHistoryFormData.comorbidityConcurrentConditionsList);
    ...
    let comorbidityData = Object.assign({}, comorbidityHistoryFormData, otherDetails);
  ...
  updateGeneralPersonalHistory(personalHistoryForm, temp) {
    ...
    let personalHistoryData = Object.assign({}, personalHistoryFormValue, temp, {
      riskySexualPracticesStatus: (personalHistoryFormValue.riskySexualPracticesStatus!=undefined) ? +(personalHistoryFormValue.riskySexualPracticesStatus) : null,
  ...
  updateGeneralMenstrualHistory(menstrualHistory, otherDetails) {
    ...
    if (temp.lMPDate == null || temp.lMPDate == undefined || temp.lMPDate == 'Invalid Date') {
      delete temp['lMPDate']
    }
  ...
  updateGeneralPastObstetricHistory(pastObstetricHistoryForm, temp) {
    ...
    let pastObstetricHistoryData = Object.assign({}, pastObstetricHistoryFormValue, temp, { femaleObstetricHistoryList: pastObstetricHistoryFormValue.pastObstericHistoryList, pastObstericHistoryList: undefined });
    return pastObstetricHistoryData;
  }

  updateGeneralImmunizationHistory(immunizationHistoryForm, temp) {
    let immunizationHistoryFormValue = JSON.parse(JSON.stringify(immunizationHistoryForm.value));
    ...
    //   })
    // })
    let immunizationHistoryData = Object.assign({}, { immunizationList: formData }, temp);
  ...
  updateGeneralOtherVaccines(otherVaccinesForm, temp) {
    ...
    let otherVaccinesData = Object.assign({}, { childOptionalVaccineList: otherVaccines }, temp);
  ...
  updateGeneralVitals(patientVitalsForm, visitCategory) {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID;
    let patientVitalData = Object.assign({}, patientVitalsForm.value, patientVitalsForm.getRawValue(), {
      providerServiceMapID: localStorage.getItem('providerServiceID'), modifiedBy: localStorage.getItem('userName'), sessionID: localStorage.getItem('sessionID'),
      parkingPlaceID: parkingPlaceID, vanID: vanID,
      beneficiaryRegID: "" + localStorage.getItem('beneficiaryRegID'),
      visitCode: localStorage.getItem('visitCode'),
      benVisitID: localStorage.getItem('visitID'),
    ...
    if (visitCategory == 'ANC') {
      return this.http.post(environment.updateANCVitalsDetailsUrl, patientVitalData)
        .map((res) => res.json()).pipe(shareReplay(1));
    }
    if (visitCategory == 'General OPD') {
      return this.http.post(environment.updateGeneralOPDVitalsDetailsUrl, patientVitalData)
        .map((res) => res.json()).pipe(shareReplay(1));
    }
    if (visitCategory == 'NCD care') {
      return this.http.post(environment.updateNCDCareVitalsDetailsUrl, patientVitalData)
        .map((res) => res.json()).pipe(shareReplay(1));
    }

    if (visitCategory == 'PNC') {
      return this.http.post(environment.updatePNCVitalsDetailsUrl, patientVitalData)
        .map((res) => res.json()).pipe(shareReplay(1));
    }
    if (visitCategory == 'COVID-19 Screening') {
      return this.http.post(environment.updateCovidCareVitalsDetailsUrl, patientVitalData)
        .map((res) => res.json()).pipe(shareReplay(1));
    }
    if (visitCategory == 'NCD screening') {
      return this.http.post(environment.updateNCDVitalsDetailsUrl, patientVitalData)
        .map((res) => res.json()).pipe(shareReplay(1));
    }
  }
  ...
  updateIDRSDetails(idrsScreeningForm, visitCategory) {
    ...
    if (visitCategory == 'NCD screening') {
      return this.http.post(environment.updateNCDScreeningIDRSDetailsUrl,idrsDetails)
        .map((res) => res.json()).pipe(shareReplay(1));
    }
  }
  updatePatientExamination(patientExaminationForm, visitCategory, updateDetails) {
    let updatedExaminationDetails;
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID;
    if (visitCategory == 'ANC') {
      updatedExaminationDetails = {
        "generalExamination": this.updateGeneralExaminationForm(patientExaminationForm.generalExaminationForm, updateDetails),
        "headToToeExamination": this.updateHeadToToeExaminationForm(patientExaminationForm.headToToeExaminationForm, updateDetails),
        "cardioVascularExamination": this.updateCardioVascularSystemForm(patientExaminationForm.systemicExaminationForm.cardioVascularSystemForm, updateDetails),
        "respiratorySystemExamination": this.updateRespiratorySystemForm(patientExaminationForm.systemicExaminationForm.respiratorySystemForm, updateDetails),
        "centralNervousSystemExamination": this.updateCentralNervousSystemForm(patientExaminationForm.systemicExaminationForm.centralNervousSystemForm, updateDetails),
        "musculoskeletalSystemExamination": this.updateMusculoSkeletalSystemForm(patientExaminationForm.systemicExaminationForm.musculoSkeletalSystemForm, updateDetails),
        "genitoUrinarySystemExamination": this.updateGenitoUrinarySystemForm(patientExaminationForm.systemicExaminationForm.genitoUrinarySystemForm, updateDetails),
        "obstetricExamination": this.updateANCObstetricExamination(patientExaminationForm.systemicExaminationForm.obstetricExaminationForANCForm, updateDetails),
        sessionID: localStorage.getItem('sessionID'),
        parkingPlaceID: parkingPlaceID, vanID: vanID,
        beneficiaryRegID: "" + localStorage.getItem('beneficiaryRegID'),
        providerServiceMapID: localStorage.getItem('providerServiceID'),
      ...
      console.log("Update ANC Examination", JSON.stringify(updatedExaminationDetails, null, 4));

      return this.http.post(environment.updateANCExaminationDetailsUrl, updatedExaminationDetails)
        .map(res => res.json()).pipe(shareReplay(1));
    }
    ...
    if (visitCategory == 'PNC') {
      updatedExaminationDetails = {
        "generalExamination": this.updateGeneralExaminationForm(patientExaminationForm.generalExaminationForm, updateDetails),
        "headToToeExamination": this.updateHeadToToeExaminationForm(patientExaminationForm.headToToeExaminationForm, updateDetails),
        "gastroIntestinalExamination": this.updateGastroIntestinalSystemForm(patientExaminationForm.systemicExaminationForm.gastroIntestinalSystemForm, updateDetails),
        "cardioVascularExamination": this.updateCardioVascularSystemForm(patientExaminationForm.systemicExaminationForm.cardioVascularSystemForm, updateDetails),
        "respiratorySystemExamination": this.updateRespiratorySystemForm(patientExaminationForm.systemicExaminationForm.respiratorySystemForm, updateDetails),
        "centralNervousSystemExamination": this.updateCentralNervousSystemForm(patientExaminationForm.systemicExaminationForm.centralNervousSystemForm, updateDetails),
        "musculoskeletalSystemExamination": this.updateMusculoSkeletalSystemForm(patientExaminationForm.systemicExaminationForm.musculoSkeletalSystemForm, updateDetails),
      ...
      console.log("Update PNC Examination", JSON.stringify(updatedExaminationDetails, null, 4));

      return this.http.post(environment.updatePNCExaminationDetailsUrl, updatedExaminationDetails)
        .map(res => res.json()).pipe(shareReplay(1));
    }
    ...
    if (visitCategory == 'General OPD') {
      ...
      console.log("Update General OPD Examination", JSON.stringify(updatedExaminationDetails, null, 4));

      return this.http.post(environment.updateGeneralOPDExaminationDetailsUrl, updatedExaminationDetails)
        .map(res => res.json()).pipe(shareReplay(1));
    }
  ...
  postGeneralCaseRecordFindings(findingForm, otherDetails) {
    ...
    let findingFormData = Object.assign({}, findingFormValue, { complaints }, otherDetails);
  ...
  postNCDCareCaseRecordDiagnosis(diagnosisForm, otherDetails) {
    ...
    if (diagnosisFormData.ncdCareType) {
      diagnosisFormData.ncdCareTypeID = diagnosisFormData.ncdCareType.ncdCareTypeID;
      diagnosisFormData.ncdCareType = diagnosisFormData.ncdCareType.ncdCareType;
    }
  ...
  postCovidCareCaseRecordDiagnosis(diagnosisForm, otherDetails) {
    let diagnosisFormData = Object.assign({}, diagnosisForm.value, otherDetails);
    return diagnosisFormData;
  }
  ...
  postGeneralCaseRecordInvestigation(investigationForm, otherDetails) {
    let investigationFormValue = JSON.parse(JSON.stringify(investigationForm.value));
    let labTest = [];
    if (!!investigationFormValue.labTest && !!investigationFormValue.radiologyTest)
      labTest = investigationFormValue.labTest.concat(investigationFormValue.radiologyTest);

    let temp = labTest.filter(test => {
      return !test.disabled;
    })
    labTest = temp.slice();
    let investigationFormData = Object.assign({}, investigationFormValue, otherDetails,
  ...
  postGeneralCaseRecordPrescription(prescriptionForm, otherDetails) {
    const prescriptionFormValue = JSON.parse(JSON.stringify(prescriptionForm.value));
  ...
  postGeneralRefer(referForm, otherDetails) {
    ...
    if (referFormData.referredToInstituteName) {
      referFormData.referredToInstituteID = referFormData.referredToInstituteName.institutionID;
      referFormData.referredToInstituteName = referFormData.referredToInstituteName.institutionName;
    }
  ...
  postOncologistRemarksforCancerCaseSheet(remarks, visitID, regID) {
    return this.http.post(environment.updateOncologistRemarksCancelUrl,
      { beneficiaryRegID: regID, benVisitID: visitID, modifiedBy: localStorage.getItem('userName'), providerServiceMapID: localStorage.getItem('providerServiceID'), visitCode: localStorage.getItem('visitCode'), provisionalDiagnosisOncologist: remarks })
      .map(res => res.json())
  }
  ...
  postDoctorPNCDetails(patientMedicalForm, otherDetails, tcRequest) {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID
    let findingForm = (<FormGroup>patientMedicalForm.controls['patientCaseRecordForm']).controls['generalFindingsForm'];
    let investigationForm = (<FormGroup>patientMedicalForm.controls['patientCaseRecordForm']).controls['generalDoctorInvestigationForm'];
    ...
    console.log("PNC Doctor Visit Details", JSON.stringify(pncVisitDetails, null, 4));
  ...
  getPNCDetails(beneficiaryID: string, visitID: string) {
    return this.http.post(environment.getPNCDetailsUrl, { benRegID: beneficiaryID, benVisitID: visitID, visitCode: localStorage.getItem('visitCode') })
      .map(res => res.json())
  }
  ...
  updatePNCDetails(patientPNCForm, otherDetails) {
    ...
    console.log('json', JSON.stringify({ "PNCDetails": updatedPNCDetails }, null, 4));

    return this.http.post(environment.updatePNCDetailsUrl, { "PNCDetails": updatedPNCDetails })
      .map(res => res.json()).pipe(shareReplay(1));
  }
  ...
  */
  ...
  getPreviousSignificiantFindings(beneficiaryRegID) {
    return this.http.post(environment.getPreviousSignificiantFindingUrl, beneficiaryRegID)
      .map(res => res.json());
  }

  caseRecordAndReferDetails: any;
  getCaseRecordAndReferDetails(beneficiaryRegID, visitID, visitCategory) {
    let otherDetails = Object.assign({ benRegID: beneficiaryRegID, benVisitID: visitID, visitCode: localStorage.getItem('visitCode') })

    if (!this.caseRecordAndReferDetails) {
      if (visitCategory == 'Cancer Screening') {
        this.caseRecordAndReferDetails = this.http.post(environment.getCancerScreeningDoctorDetails, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'General OPD (QC)') {
        this.caseRecordAndReferDetails = this.http.post(environment.getGeneralOPDQuickConsultDoctorDetails, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'ANC') {
        this.caseRecordAndReferDetails = this.http.post(environment.getANCDoctorDetails, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'General OPD') {
        this.caseRecordAndReferDetails = this.http.post(environment.getGeneralOPDDoctorDetails, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'NCD screening') {
        this.caseRecordAndReferDetails = this.http.post(environment.getNCDScreeningDoctorDetails, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'NCD care') {
        this.caseRecordAndReferDetails = this.http.post(environment.getNCDCareDoctorDetails, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'PNC') {
        this.caseRecordAndReferDetails = this.http.post(environment.getPNCDoctorDetails, otherDetails)
          .map(res => res.json())

      }
      if (visitCategory == 'COVID-19 Screening') {
        this.caseRecordAndReferDetails = this.http.post(environment.getCovidDoctorDetails, otherDetails)
          .map(res => res.json())
  ...
  updateDoctorDiagnosisDetails(patientMedicalForm, visitCategory, otherDetails, tcRequest) {
    let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
    let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID
    let findingForm = (<FormGroup>patientMedicalForm.controls['patientCaseRecordForm']).controls['generalFindingsForm'];
    let investigationForm = (<FormGroup>patientMedicalForm.controls['patientCaseRecordForm']).controls['generalDoctorInvestigationForm'];
    ...
    let updatedDoctorDiagnosis = {
      "findings": this.postGeneralCaseRecordFindings(findingForm, otherDetails),
      "diagnosis": this.postGeneralCaseRecordDiagnosis(diagnosisForm, visitCategory, otherDetails),
      "investigation": this.postGeneralCaseRecordInvestigation(investigationForm, otherDetails),
      "prescription": this.postGeneralCaseRecordPrescription(prescriptionForm, otherDetails),
      "refer": this.postGeneralRefer(referForm, otherDetails),
      "benFlowID": localStorage.getItem('benFlowID'),
    ...
    console.log("updated doctor details", JSON.stringify(updatedDoctorDiagnosis, null, 4));

    if (visitCategory == 'ANC') {
      return this.http.post(environment.updateANCDoctorDetails, updatedDoctorDiagnosis)
        .map(res => res.json()).pipe(shareReplay(1));
    }
    if (visitCategory == 'General OPD') {
      return this.http.post(environment.updateGeneralOPDDoctorDetails, updatedDoctorDiagnosis)
        .map(res => res.json()).pipe(shareReplay(1));
    }
    if (visitCategory == 'NCD care') {
      return this.http.post(environment.updateNCDCareDoctorDetails, updatedDoctorDiagnosis)
        .map(res => res.json()).pipe(shareReplay(1));
    }
    if (visitCategory == 'PNC') {
      return this.http.post(environment.updatePNCDoctorDetails, updatedDoctorDiagnosis)
        .map(res => res.json()).pipe(shareReplay(1));
    }
    if (visitCategory == 'COVID-19 Screening') {
      return this.http.post(environment.updateCovidDoctorDetails, updatedDoctorDiagnosis)
        .map(res => res.json()).pipe(shareReplay(1));
    }
    if (visitCategory == 'NCD screening') {
      return this.http.post(environment.updateNCDScreeningDoctorDetails, updatedDoctorDiagnosis)
        .map(res => res.json()).pipe(shareReplay(1));
    }
  }
  ...
  postGeneralCaseRecordDiagnosis(diagnosisForm, visitCategory, otherDetails) {
    ...
    if (visitCategory == 'ANC') {
      diagnosisDetails = this.postANCCaseRecordDiagnosis(diagnosisForm, otherDetails);
    }
    if (visitCategory == 'General OPD') {
      diagnosisDetails = this.postGeneralOPDCaseRecordDiagnosis(diagnosisForm, otherDetails);
    }
    if (visitCategory == 'NCD care') {
      diagnosisDetails = this.postNCDCareCaseRecordDiagnosis(diagnosisForm, otherDetails);
    }
    if (visitCategory == 'PNC') {
      diagnosisDetails = this.postANCCaseRecordDiagnosis(diagnosisForm, otherDetails);
    }
    if (visitCategory == 'COVID-19 Screening') {
      diagnosisDetails = this.postCovidCareCaseRecordDiagnosis(diagnosisForm, otherDetails);
    }
    if (visitCategory == 'NCD screening') {
      diagnosisDetails = this.postNCDscreeningCaseRecordDiagnosis(diagnosisForm, otherDetails);
    }
  ...
  getMMUCasesheetData(caseSheetRequest) {
    ...
    return this.http.post(environment.getMMUCasesheetDataUrl, caseSheetRequest).map(res =>
      res.json());
  }
  ...
  getTMCasesheetData(caseSheetRequest) {
    ...
    return this.http.post(environment.getTMCasesheetDataUrl, caseSheetRequest).map(res =>
      res.json());
  }
  ...
  beneficiaryTCRequestStatus(beneficiaryTCRequest) {
    ...
    return this.http.post(environment.beneficiaryTCRequestStatusUrl, beneficiaryTCRequest)
      .map(response => response.json());
  }
  ...
  saveSpecialistCancerObservation(specialistDiagonosis, otherDetails) {
    let diagnosisDetails = specialistDiagonosis.controls.patientCaseRecordForm.value;
    ...
    let diagnosis = Object.assign({}, referDetails, diagnosisDetails, otherDetails)
    console.log('saveSpecialistCancerObservation', JSON.stringify({ diagnosis }, null, 4));
    return this.http.post(environment.saveSpecialistCancerObservationUrl, { diagnosis })
  ...
  updateNCDScreeningHistory(NCDScreeningHistoryForm, temp, beneficiaryAge) {
    ...
    let updatedHistoryDetails = {
      ...
      "familyHistory": this.updateGeneralFamilyHistory(NCDScreeningHistoryForm.controls.familyHistory, temp),
      "physicalActivityHistory": this.updatePhyscialActivityHistory(NCDScreeningHistoryForm.controls.physicalActivityHistory, temp),
    ...
    console.log("Update NCD Screening History", JSON.stringify(updatedHistoryDetails, null, 4));

    if (visitCategory == 'NCD screening') {
      return this.http.post(environment.updateNCDScreeningHistoryDetailsUrl, updatedHistoryDetails)
        .map(res => res.json()).pipe(shareReplay(1));
    }
  ...
  getIDRSDetails(beneficiaryID: string, visitID: string) {
    ...
    let otherDetails = Object.assign({ benRegID: beneficiaryID, benVisitID: visitID, visitCode: localStorage.getItem('visitCode') })
      ...
      if (visitCategory == 'NCD screening') {
       return this.http.post(environment.getNCDScreeningIDRSDetails, otherDetails)
          .map(res => res.json())
    ...
    postTMReferedNurseDetails(patientMedicalForm, otherDetails, tcRequest) {
      let vanID = JSON.parse(localStorage.getItem('serviceLineDetails')).vanID;
      let parkingPlaceID = JSON.parse(localStorage.getItem('serviceLineDetails')).parkingPlaceID     
      let referForm =  (<FormGroup>patientMedicalForm.controls["patientVisitForm"]).controls["tmcConfirmationForm"];
      let isTMCDone = referForm.value.tmcConfirmed;
      let beneficiaryData = JSON.parse(localStorage.getItem("beneficiaryData"))
      let generalVisitDetails = {       
        prescription: this.prescribedDrugData? this.prescribedDrugData : null,
        refer: this.postTMVisitDatilsRefer(referForm, otherDetails,beneficiaryData),
        benFlowID: localStorage.getItem('benFlowID'),
        beneficiaryID: localStorage.getItem('beneficiaryID'),
        doctorFlag: String(beneficiaryData.doctorFlag),
        nurseFlag: String(beneficiaryData.nurseFlag),
        pharmacist_flag: beneficiaryData.pharmacist_flag == "Not Available" ? 0 : 1,
        isSpecialist:false,
        sessionID: localStorage.getItem('sessionID'),
        parkingPlaceID: parkingPlaceID, vanID: vanID,
        beneficiaryRegID: "" + localStorage.getItem('beneficiaryRegID'),
      ...
      console.log("TM Nurse Details", JSON.stringify(generalVisitDetails, null, 4));

      return this.http.post(environment.postNCDScreeningDetails, generalVisitDetails)
        .map(res => res.json());
      // return Observable.of({errorMessage: 'furrrr'});
    }

  postTMVisitDatilsRefer(referForm, otherDetails,beneficiaryData) {
    let referFormData = JSON.parse(JSON.stringify(referForm.value));
    let temp = {};
    if (referFormData.refrredToAdditionalServiceList) {
      temp = {
        referredToInstituteID: referFormData.refrredToAdditionalServiceList.institutionID,
        referredToInstituteName: referFormData.refrredToAdditionalServiceList.institutionName,
    ...
    let referData = Object.assign({}, temp, otherDetails);
    return referData;
  }
  HRPDetails: any;
