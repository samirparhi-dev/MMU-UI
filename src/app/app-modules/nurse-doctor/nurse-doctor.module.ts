...
import { PrescribeTmMedicineComponent } from '../nurse-doctor/case-sheet/prescribe-tm-medicine/prescribe-tm-medicine.component';
...
@NgModule({
  ...
  providers: [NurseService, DoctorService, MasterdataService, WorkareaCanActivate,HttpServiceService, LabService,IdrsscoreService,TestInVitalsService],
