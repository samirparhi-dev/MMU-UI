import { Component, OnInit, Input, ViewChildren, QueryList, ElementRef,SimpleChanges } from '@angular/core';
...
export class PastObstericHistoryComponent implements OnInit {
