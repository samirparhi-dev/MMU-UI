    ...
    this.doctorService.getPNCDetails(benRegID, visitID).subscribe((pNCdata) => {
      ...
      if (this.masterData.deliveryComplicationTypes) {
        tempPNCData.deliveryComplication =
          this.masterData.deliveryComplicationTypes.filter((data) => {
            return (
              data.deliveryComplicationType == tempPNCData.deliveryComplication
            );
          })[0];
      }
      ...
      if (this.masterData.postNatalComplications) {
        tempPNCData.postNatalComplication =
          this.masterData.postNatalComplications.filter((data) => {
      ...
      if (this.masterData.newbornHealthStatuses) {
        tempPNCData.newBornHealthStatus =
          this.masterData.newbornHealthStatuses.filter((data) => {
